...
export class OKX {
    ...
    async main() {
        const requesId = "query_id=AAHtGexgAgAAAO0Z7GCOD8xg&user=%7B%22id%22%3A5921053165%2C%22first_name%22%3A%22Di%E1%BB%87p%22%2C%22last_name%22%3A%22Minh%22%2C%22username%22%3A%22diepminh04%22%2C%22language_code%22%3A%22en%22%2C%22allows_write_to_pm%22%3Atrue%7D&auth_date=1726823474&hash=3f64362bc597b13f9deb13f041d73a93394871aaa77320110be3e455b93c17a7";
        const proxy = "http://kgkyanao:5e1zp9rkiiup@38.154.227.167:5868";
        const coverId = requesId.replace(/\r/g, '')
        const coverProxy = proxy.replace(/\r/g, '')
        const userData = [coverId];
        const proxyData = [coverProxy];
